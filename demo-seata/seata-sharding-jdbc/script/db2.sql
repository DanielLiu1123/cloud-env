...
MySQL - 5.7.32-log : Database - seata_sharding_jdbc_2
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`seata_sharding_jdbc_2` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `seata_sharding_jdbc_2`;
...
insert  into `order_2`(`id`,`user_id`,`commodity_code`,`count`,`money`) values ('1392793467052818434','111','2',10,'2.50'),('1392794012111011842','111','2',10,'2.50'),('1392795595867619330','111','2',10,'2.50'),('1392797579148460034','111','1',10,'2.50');
...
insert  into `storage_1`(`id`,`commodity_code`,`count`) values ('1','5',100),('2','1',100),('3','3',100),('4','2',80),('5','4',100),('6','6',100);
...
insert  into `storage_2`(`id`,`commodity_code`,`count`) values ('1','5',100),('2','1',100),('3','3',100),('4','2',60),('5','4',100),('6','6',100);
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='AT transaction mode undo table';
